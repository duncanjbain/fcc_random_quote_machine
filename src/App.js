          ...
          <div className="row">
            <div className="col-lg-6 mx-auto">
              <blockquote className="blockquote bg-white p-5 shadow rounded">
                ...
                <p className="mb-0 mt-2 font-italic" id='text'>{this.state.quote.content}</p> {/* fetch quote from state and render */}
                <footer className="blockquote-footer pt-4 mt-4 border-top pb-3" id='author'>{this.state.quote.author} {/* fetch quote author from state and render */}
                </footer>
